...
CvRatation_Parameter cvLevenberg_Marquardt(CvPoint* Object_Point_Val,CvPoint* Reference_Point_Val,int Heigth_Val,int Width_Val,int count)
{
	...
	*****************************************************************************************************************/
	...
	//printf("%f,%f,%f\n",Result_Temp.Thata*180/CV_PI,Result_Temp.Center_X,Result_Temp.Center_Y);
	...
	{
		/*****************************************************************
		x =-(A*cos(Thata) - A + B*sin(Thata))/(cos(Thata)^2 - 2*cos(Thata) + sin(Thata)^2 + 1)
		y =(B - B*cos(Thata) + A*sin(Thata))/(cos(Thata)^2 - 2*cos(Thata) + sin(Thata)^2 + 1)
		*****************************************************************/
		...
		//Result_Temp.Thata=Result_Temp.Thata*180/CV_PI;
		return Result_Temp;
	}
}
